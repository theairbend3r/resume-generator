  ...
  <WithWizard
    render={({ next, previous, step, steps }) => (
      <div tw="flex flex-row w-full items-center justify-around my-6 md:my-8 xl:my-10">
        ...
        {steps.indexOf(step) === steps.length - 1 && (
          <button tw="bg-gradient-to-r from-pink-800 to-purple-800 hover:from-pink-700 hover:to-purple-700 w-full text-white rounded-lg px-2 py-3 md:px-4 md:py-5 text-sm md:text-base xl:text-lg">
            Submit
          </button>
        )}
      </div>
